...
setwd("C://Users/tno010/Desktop/SMED8020/2021/Day2/")
```
...
The phenotype in today´s practical is dummy phenotype created for this practical but based on real data from the 
1000-genomes project. The data-set consist of 1001 cases and 1001 controls and only chr 22.
...
Open Term or Ubuntu or command line of choice, NB: commands differ slightly
...
you will get the message "day2.bed" may be a binary file. See it anyway?
...
Every subsequent PLINK command will make these two other files togehter with the analyses output.
...
assoc <- read.table("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/results.assoc.logistic", header=T, as.is=T)
...
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/assoc_plot.pdf", assoc_plot)
...
NB: remember that you can use the Plink website to look for things like 
what the column headers mean or what the functions do
...
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/mishet.pdf", mishet_plot)
...
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/mishet_excl_1.pdf", mishet_excl_plot)
...
##### In R session:
```{r }
write.table(fail_mis_qc, "C://Users/tno010/Desktop/SMED8020/2021/Day2/output/fail_mis_qc.txt", row.names=F, col.names=T, quote=F)

write.table(fail_het_qc, "C://Users/tno010/Desktop/SMED8020/2021/Day2/output/fail_het_qc.txt", row.names=F, col.names=T, quote=F)
...
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/ibd.stat.pdf", ibd.stat_plot)
...
write.table(fail_ibd_qc, "C://Users/tno010/Desktop/SMED8020/2021/Day2/output/fail_ibd_qc.txt", row.names=F, col.names=T, quote=F)
...
###### In R session:
```{r }
fail_mis_qc <- read.table("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/fail_mis_qc.txt",header=T,as.is=T)

fail_het_qc <- read.table("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/fail_het_qc.txt", header=T, as.is=T)

fail_ibd_qc <- read.table("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/fail_ibd_qc.txt", header=T, as.is=T)
...
write.table(fail_qc, "C://Users/tno010/Desktop/SMED8020/2021/Day2/output/fail_qc.txt", row.names=F, col.names=F, quote=F)
```
...
lmis <- read.table("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/qc.ind.mis.lmiss",header=T)
...
mis1_genot_plot
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/qc_ind_lmis_1.pdf", mis1_genot_plot)
```
...
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/qc_ind_lmis_2.pdf", mis_genot_plot_2)
```
...
freq <- read.table("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/qc.ind.freq.frq", header=T)
...
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/maf.pdf", maf_plot)
```
...
diffmiss <- read.table("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/qc.ind.call.rate.missing", header=T, as.is=T)

#save SNPs with p-value < 0.000001 into a file
diff.miss <- diffmiss[diffmiss$P<0.000001,]

head(diff.miss); dim(diff.miss)
write.table(diff.miss$SNP, "C://Users/tno010/Desktop/SMED8020/2021/Day2/output/fail_diffmiss_qc.txt", row.names=F, col.names=F, quote=F)
...
assoc.qc <- read.table("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/day2.qc.log.assoc.logistic", header=T, as.is=T)
...
# Saving plots
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/comparison_beforeQC.pdf", QC_before_plot)
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/comparison_afterQC.pdf", QC_after_plot)
```
...
#save plot
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/qq_plot_beforeQC.pdf", qq_plot_beforeQC)
...
#save plot
ggsave("C://Users/tno010/Desktop/SMED8020/2021/Day2/output/qq_plot_after.pdf", qq_plot_afterQC)
